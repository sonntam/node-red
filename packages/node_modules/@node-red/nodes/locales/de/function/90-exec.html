...
<script type="text/html" data-help-name="exec">
    ...
    <dl class="message-properties">
        ...
        <dt class="optional">stdin <span class="property-type">binary | string</span></dt>
        <dd>Daten, die per stdin pipe an den Prozess übergeben werden sollen.</dd>
    </dl>
    <h3>Ausgangsdaten</h3>
    <ol class="node-ports">
    ...
    <p>Mittels <code>msg.stdin</code> können Daten an den zu startenden Prozess per stdin pipe
       übergeben werden. Die stdin pipe wird immer nach übertragen der Daten geschlossen und kann
       nicht offengehalten werden.</p>
