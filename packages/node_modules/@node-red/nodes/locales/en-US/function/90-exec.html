...
<script type="text/html" data-help-name="exec">
    ...
    <dl class="message-properties">
        ...
        <dd>data that should be input to the process via stdin pipe.</dd>
    </dl>
    ...
    <p>Sending <code>msg.stdin</code> will pipe data to the started process' stdin pipe. The pipe is closed
        immediately after sending the data and it cannot be kept open.</p>
