...
<script type="text/html" data-help-name="exec">
    ...
    <dl class="message-properties">
        ...
        <dd>dados que devem ser inseridos no processo por meio do pipe stdin.</dd>
    </dl>
    ...
    <p>O envio de <code>msg.stdin</code> encaminhará dados para o pipe stdin do processo iniciado. O pipe é fechado imediatamente após o envio dos dados e não pode ser mantido aberto.</p>
