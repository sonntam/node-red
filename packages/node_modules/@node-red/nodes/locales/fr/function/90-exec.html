...
<script type="text/html" data-help-name="exec">
    ...
    <dl class="message-properties">
        ...
        <dd>données qui doivent être entrées dans le processus via le tuyau stdin.</dd>
    </dl>
    ...
    <p>L’envoi de <code>msg.stdin</code> acheminera les données vers le tuyau stdin du processus démarré. Le tuyau est fermé immédiatement après l’envoi des données et ne peut pas être maintenu ouvert.</p>
