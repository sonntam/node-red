...
<script type="text/html" data-help-name="exec">
  ...
  <dl class="message-properties">
    ...
    <dd>данные, которые необходимо ввести в процесс через канал stdin.</dd>
  </dl>
  ...
  <p>Отправка <code>msg.stdin</code> направит данные в канал stdin запущенного процесса. Канал закрывается немедленно после отправки данных и не может быть оставлен открытым.</p>
  <p>
