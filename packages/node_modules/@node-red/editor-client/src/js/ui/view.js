...
RED.view = (function() {
    ...
    function init() {
        ...
        chart.on('contextmenu', function(evt) {
            ...
            if( evt.ctrlKey ) {
                // Quick one-click connect functionality was triggered
    ...
    function nodeMouseDown(d) {
        ...
        if (d3.event.ctrlKey && d3.event.button === 2) {
            // Get selected set of nodes and right-clicked node
            var selection = getSelection();
            var targetNode = d;
            
            // Do not connect to self
            var sourceNodes = selection.nodes.filter(x => x !== targetNode);
